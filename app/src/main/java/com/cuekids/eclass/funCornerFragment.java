...
public class funCornerFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public static funCornerFragment newInstance(String param1, String param2) {
        funCornerFragment fragment = new funCornerFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentFunCornerBinding.inflate(inflater, container, false);

//        if (getSupportActionBar() != null) {
//            getSupportActionBar().setDisplayHomeAsUpEnabled(true);
//        }

        binding.webview.setWebViewClient(new funCornerFragment.MyWebViewClient());
        ...
        String url = "https://eclass.cuekids.in/fun-corner/";
        setWebView(url);
